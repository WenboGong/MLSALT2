tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l g -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/g 
...
Reestimating HMM hmm0/mono/g . . . 
 ...
 - system is PLAIN
1186 Examples loaded, Max length = 21, Min length = 3
Ave LogProb at iter 1 = -182.33188 using 1186 examples
Ave LogProb at iter 2 = -182.33136 using 1186 examples  change =    0.00052
Ave LogProb at iter 3 = -182.33128 using 1186 examples  change =    0.00008
