tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l v -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/v 
...
Reestimating HMM hmm0/mono/v . . . 
 ...
 - system is PLAIN
1990 Examples loaded, Max length = 20, Min length = 3
Ave LogProb at iter 1 = -151.93761 using 1990 examples
Ave LogProb at iter 2 = -151.93532 using 1990 examples  change =    0.00229
Ave LogProb at iter 3 = -151.93405 using 1990 examples  change =    0.00127
Ave LogProb at iter 4 = -151.93329 using 1990 examples  change =    0.00076
Ave LogProb at iter 5 = -151.93271 using 1990 examples  change =    0.00058
Ave LogProb at iter 6 = -151.93253 using 1990 examples  change =    0.00018
Ave LogProb at iter 7 = -151.93234 using 1990 examples  change =    0.00018
Ave LogProb at iter 8 = -151.93204 using 1990 examples  change =    0.00031
Ave LogProb at iter 9 = -151.93213 using 1990 examples  change =   -0.00009
