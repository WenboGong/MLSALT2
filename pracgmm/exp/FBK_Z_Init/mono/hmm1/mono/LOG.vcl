tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l vcl -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/vcl 
...
Reestimating HMM hmm0/mono/vcl . . . 
 States   :   2  3  4 (width)
 Mixes  s1:   1  1  1 ( 24  )
 Num Using:   0  0  0
 Parm Kind:  FBANK_Z
 ...
 - system is PLAIN
1660 Examples loaded, Max length = 21, Min length = 3
Ave LogProb at iter 1 = -172.59398 using 1660 examples
Ave LogProb at iter 2 = -172.59378 using 1660 examples  change =    0.00020
Ave LogProb at iter 3 = -172.59386 using 1660 examples  change =   -0.00008
