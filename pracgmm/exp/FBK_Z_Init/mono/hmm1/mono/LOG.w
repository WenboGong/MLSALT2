tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l w -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/w 
...
Reestimating HMM hmm0/mono/w . . . 
 ...
 - system is PLAIN
2187 Examples loaded, Max length = 22, Min length = 3
Ave LogProb at iter 1 = -106.41639 using 2187 examples
Ave LogProb at iter 2 = -106.41507 using 2187 examples  change =    0.00132
Ave LogProb at iter 3 = -106.41491 using 2187 examples  change =    0.00016
Ave LogProb at iter 4 = -106.41494 using 2187 examples  change =   -0.00003
