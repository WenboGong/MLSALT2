tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l f -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/f 
...
Reestimating HMM hmm0/mono/f . . . 
 ...
 - system is PLAIN
2214 Examples loaded, Max length = 32, Min length = 3
Ave LogProb at iter 1 = -191.62717 using 2214 examples
Ave LogProb at iter 2 = -191.62695 using 2214 examples  change =    0.00021
Ave LogProb at iter 3 = -191.62691 using 2214 examples  change =    0.00005
