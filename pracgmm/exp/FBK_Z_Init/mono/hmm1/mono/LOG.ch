tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l ch -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/ch 
...
Reestimating HMM hmm0/mono/ch . . . 
 ...
 - system is PLAIN
820 Examples loaded, Max length = 42, Min length = 6
Ave LogProb at iter 1 = -279.15863 using 820 examples
Ave LogProb at iter 2 = -279.15793 using 820 examples  change =    0.00070
Ave LogProb at iter 3 = -279.15787 using 820 examples  change =    0.00006
