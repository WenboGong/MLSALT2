tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l p -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/p 
...
Reestimating HMM hmm0/mono/p . . . 
 ...
 - system is PLAIN
2586 Examples loaded, Max length = 28, Min length = 3
Ave LogProb at iter 1 = -233.63130 using 2586 examples
Ave LogProb at iter 2 = -233.63109 using 2586 examples  change =    0.00021
Ave LogProb at iter 3 = -233.63124 using 2586 examples  change =   -0.00015
Ave LogProb at iter 4 = -233.63124 using 2586 examples  change =    0.00000
