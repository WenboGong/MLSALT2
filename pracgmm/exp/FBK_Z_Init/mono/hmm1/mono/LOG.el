tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l el -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/el 
...
Reestimating HMM hmm0/mono/el . . . 
 ...
 - system is PLAIN
951 Examples loaded, Max length = 23, Min length = 4
Ave LogProb at iter 1 = -160.97000 using 951 examples
Ave LogProb at iter 2 = -160.96948 using 951 examples  change =    0.00052
Ave LogProb at iter 3 = -160.96927 using 951 examples  change =    0.00021
Ave LogProb at iter 4 = -160.96935 using 951 examples  change =   -0.00008
