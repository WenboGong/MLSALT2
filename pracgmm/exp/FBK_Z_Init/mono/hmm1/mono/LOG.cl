tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l cl -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/cl 
...
Reestimating HMM hmm0/mono/cl . . . 
 ...
 - system is PLAIN
2711 Examples loaded, Max length = 36, Min length = 3
Ave LogProb at iter 1 = -189.40665 using 2711 examples
Ave LogProb at iter 2 = -189.40648 using 2711 examples  change =    0.00017
Ave LogProb at iter 3 = -189.40657 using 2711 examples  change =   -0.00009
