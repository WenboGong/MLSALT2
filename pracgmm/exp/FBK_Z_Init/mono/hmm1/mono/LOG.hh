tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l hh -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/hh 
...
Reestimating HMM hmm0/mono/hh . . . 
 ...
 - system is PLAIN
1656 Examples loaded, Max length = 26, Min length = 3
Ave LogProb at iter 1 = -143.70494 using 1656 examples
Ave LogProb at iter 2 = -143.70335 using 1656 examples  change =    0.00159
Ave LogProb at iter 3 = -143.70309 using 1656 examples  change =    0.00026
Ave LogProb at iter 4 = -143.70309 using 1656 examples  change =    0.00000
Estimation converged at iteration 4
