tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l r -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/r 
...
Reestimating HMM hmm0/mono/r . . . 
 ...
 - system is PLAIN
4651 Examples loaded, Max length = 17, Min length = 3
Ave LogProb at iter 1 = -126.11546 using 4651 examples
Ave LogProb at iter 2 = -126.11504 using 4651 examples  change =    0.00041
Ave LogProb at iter 3 = -126.11510 using 4651 examples  change =   -0.00005
