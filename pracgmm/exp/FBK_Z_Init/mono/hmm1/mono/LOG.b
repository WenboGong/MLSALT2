tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l b -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/b 
...
Reestimating HMM hmm0/mono/b . . . 
 ...
 - system is PLAIN
2016 Examples loaded, Max length = 26, Min length = 3
Ave LogProb at iter 1 = -169.11508 using 2016 examples
Ave LogProb at iter 2 = -169.11446 using 2016 examples  change =    0.00063
Ave LogProb at iter 3 = -169.11459 using 2016 examples  change =   -0.00014
Ave LogProb at iter 4 = -169.11449 using 2016 examples  change =    0.00011
Ave LogProb at iter 5 = -169.11456 using 2016 examples  change =   -0.00008
