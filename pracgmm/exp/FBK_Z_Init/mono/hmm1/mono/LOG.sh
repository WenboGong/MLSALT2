tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l sh -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/sh 
...
Reestimating HMM hmm0/mono/sh . . . 
 ...
 - system is PLAIN
1317 Examples loaded, Max length = 27, Min length = 3
Ave LogProb at iter 1 = -190.38722 using 1317 examples
Ave LogProb at iter 2 = -190.38611 using 1317 examples  change =    0.00111
Ave LogProb at iter 3 = -190.38585 using 1317 examples  change =    0.00026
Ave LogProb at iter 4 = -190.38583 using 1317 examples  change =    0.00002
