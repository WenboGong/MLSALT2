tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l m -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/m 
...
Reestimating HMM hmm0/mono/m . . . 
 ...
 - system is PLAIN
3548 Examples loaded, Max length = 27, Min length = 3
Ave LogProb at iter 1 = -133.07501 using 3548 examples
Ave LogProb at iter 2 = -133.07448 using 3548 examples  change =    0.00053
Ave LogProb at iter 3 = -133.07430 using 3548 examples  change =    0.00018
Ave LogProb at iter 4 = -133.07420 using 3548 examples  change =    0.00009
