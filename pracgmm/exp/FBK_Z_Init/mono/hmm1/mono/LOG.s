tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l s -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/s 
...
Reestimating HMM hmm0/mono/s . . . 
 ...
 - system is PLAIN
6176 Examples loaded, Max length = 39, Min length = 4
Ave LogProb at iter 1 = -203.28354 using 6176 examples
Ave LogProb at iter 2 = -203.28342 using 6176 examples  change =    0.00012
Ave LogProb at iter 3 = -203.28340 using 6176 examples  change =    0.00002
