tools/htkbin/HRest -A -D -V -T 1 -C basic.cfg -l t -M hmm1/mono -I lib/mlabs/train.mlf -S lib/flists/train.scp hmm0/mono/t 
...
Reestimating HMM hmm0/mono/t . . . 
 ...
 - system is PLAIN
3931 Examples loaded, Max length = 29, Min length = 3
Ave LogProb at iter 1 = -229.45215 using 3931 examples
Ave LogProb at iter 2 = -229.45163 using 3931 examples  change =    0.00052
Ave LogProb at iter 3 = -229.45168 using 3931 examples  change =   -0.00005
